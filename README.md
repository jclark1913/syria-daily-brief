**_Note (April 2025):_** _This repository is no longer maintained. A lot has happened since I started this project in summer 2023. For starters: the Assad regime totally collapsed in December 2024, upending the former government's decades-long control over the country's media. The news and media landscape is totally different now - and I think I'd probably approach a media monitoring project like this differently were I to start it today._
